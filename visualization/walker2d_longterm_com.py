...
df_names_temp = {}
names = ["NODE", "GPIDNODE", "GHBNODE", "PIDNODE"]
...
mesh3 = ax3.pcolormesh(df_names_temp["PIDNODE"].values.T, cmap='viridis_r', vmin=0.01, vmax=0.06, alpha=0.8, )

ax4 = fig.add_subplot(224)
ax4.set_title("GPIDNODE-RNN", fontsize=70)
ax4.set_xlabel("Epoch", fontsize=70)
mesh4 = ax4.pcolormesh(df_names_temp["GPIDNODE"].values.T, cmap='viridis_r', vmin=0.01, vmax=0.06, alpha=0.8, )
