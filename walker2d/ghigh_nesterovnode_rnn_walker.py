...
class MODEL(nn.Module):
    def __init__(self, res=False, cont=False):
        ...
        nhid = 24
        self.cell = HighNesterovNODE2(tempf(nhid, nhid), actv_h=nn.Tanh(), actv_df=nn.Tanh(), corr=2.0, corrf=False,
                              use_h=True, sign=-1, nesterov_algebraic=False)
